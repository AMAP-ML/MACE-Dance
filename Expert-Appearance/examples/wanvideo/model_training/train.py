...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        self.pipe = WanVideoPipeline.from_pretrained(torch_dtype=torch.bfloat16, device="cpu", model_configs=model_configs, 
                                                     tokenizer_config= ModelConfig(path = '/mnt/workspace/common/models/Wan2.2-Animate-14B/google/umt5-xxl/'), audio_processor_config=audio_processor_config)
        state_dict = load_state_dict("/mnt/workspace/jiashu/DiffSynth-Studio/models/train/Wan2.2-Animate-14B_full_animate_adapter_720P_continue/step-600.safetensors")
        self.pipe.animate_adapter.load_state_dict(state_dict, strict=False)
        # Training mode
...
if __name__ == "__main__":
    ...
    args.save_steps = 100
    # args.lora_checkpoint = '/mnt/workspace/jiashu/DiffSynth-Studio/models/train/Wan2.2-Animate-14B_lora_480P_lorarank32/step-1100.safetensors'
